...
| Flask 应用硬编码弱 SECRET_KEY | Flask 弱密钥会话伪造攻击 | `ref/flask-weak-secret-session-forgery.md` |
| Flask 会话 Cookie 可预测 | Flask 弱密钥会话伪造攻击 | `ref/flask-weak-secret-session-forgery.md` |
| 发现 itsdangerous 签名密钥 | Flask 弱密钥会话伪造攻击 | `ref/flask-weak-secret-session-forgery.md` |
...
| AF-045 | XML-RPC 暴力破解放大攻击 | `ref/xmlrpc-bruteforce-amplification.md` | 漏洞利用 |
| AF-046 | Flask 认证缺陷综合攻击 | `ref/flask-auth-defenses-combo-attack.md` | 漏洞发现/利用 |
| AF-047 | IP 基础认证绕过攻击 | `ref/ip-based-auth-bypass-via-ssrf.md` | 漏洞利用 |
| AF-048 | Flask 弱密钥会话伪造攻击 | `ref/flask-weak-secret-session-forgery.md` | 漏洞利用 |
| AF-049 | WordPress 认证系统攻击 | `ref/wordpress-authentication-attack.md` | 漏洞发现/利用 |
...
| WordPress /wp-login.php 用户名枚举 | 用户名枚举攻击 | `ref/account-enumeration-advanced.md` |
| WordPress 无速率限制暴力破解 | 无速率限制滥用 | `ref/no-rate-limit-abuse.md` |
| WordPress HTTP 明文凭证传输 | 凭证拦截攻击 | `ref/credential-interception-attack.md` |
| WordPress 应用密码 GET 参数泄露 | 凭证拦截攻击 | `ref/credential-interception-attack.md` |
