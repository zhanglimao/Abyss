...
| 应用仅 HTTP 部署 | HTTP-only 部署攻击 | `ref/http-only-deployment-attack.md` |
| 缓存控制配置错误 | 缓存控制配置错误 | `ref/cache-control-misconfiguration.md` |
| 应用无认证机制 | 无认证系统检测与利用 | `ref/no-authentication-system-exploitation.md` |
| 敏感信息明文存储 | 敏感信息明文存储利用 | `ref/sensitive-data-plaintext-exploitation.md` `ref/plaintext-secret-storage-exploitation-advanced.md` |
| 发现 CTF Flag 文件 | 敏感信息明文存储利用 | `ref/sensitive-data-plaintext-exploitation.md` `ref/plaintext-secret-storage-exploitation-advanced.md` |
