...
| SLA-021 | OWASP A09 综合渗透测试 | `ref/owasp-a09-pentest-methodology.md` | 全流程测试 |
| SLA-022 | CWE 映射攻击技术 | `ref/cwe-mapped-attack-techniques.md` | 漏洞利用 |
| SLA-023 | 勒索软件日志攻击 | `ref/ransomware-logging-attack.md` | 漏洞利用 |
| SLA-024 | 蜜标检测与绕过 | `ref/honeytoken-implementation-detection.md` | 漏洞利用 |
